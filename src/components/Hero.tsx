...
const Hero: React.FC = () => {
  return (
    <section id="hero" className="py-24 pt-6 md:py-32 bg-white relative mt-8">
      <div className="container mx-auto px-4">
        <div className="flex flex-col md:flex-row items-center gap-8 md:gap-12">
          ...
          <div className="w-full md:w-1/2 text-left">
            ...
            <p
              className="text-xl md:text-2xl mb-8 text-gray-600 animate-fade-in-up"
              style={{ animationDelay: "0.2s" }}
            >
              Свежие мясные полуфабрикаты в натуральном маринаде — просто открой
              и готовь. Идеально для мангала, гриля и сковородки.
            </p>
            <Button
